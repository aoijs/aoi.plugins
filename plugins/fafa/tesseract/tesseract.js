module.exports = {
  ...
  version: ["6.4.0", "6.5.0"],
  description:
    "Returns the image text content.",
  ...
  code: async (d) => {
    ...
    var languages = [
      ...
      "dan", "deu", "dzo", "ell", "eng", "enm", "epo", "est", "eus", "fas",
      ...
      "lav", "lit", "mal", "mar", "mkd", "mlt", "msa", "mya", "nep", "nld",
      "nor", "ori", "pan", "pol", "por", "pus", "ron", "rus", "san", "sin",
      "slk", "slv", "spa", "spa_old", "sqi", "srp", "srp_latn", "swa", "swe",
      "syr", "tam", "tel", "tgk", "tgl", "tha", "tir", "tur", "uig", "ukr",
